...
<div class="container mx-auto px-4 py-8">
  ...
  <div class="flex justify-end mb-4">
    <a href="<?= route('supervisor.tickets.create') ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded shadow transition duration-200">
      Add New Ticket
    </a>
  </div>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
    ...
    ?>">
        ...
        <div class="mt-4 flex justify-between text-sm">
          <a href="<?= route('supervisor.tickets.show', ['id' => $ticket->id]) ?>" class="text-blue-600 hover:underline flex items-center">
            <i class="fas fa-eye mr-1"></i>View
          </a>
          <a href="<?= route('supervisor.tickets.edit', ['id' => $ticket->id]) ?>" class="text-green-600 hover:underline flex items-center">
            <i class="fas fa-edit mr-1"></i>Edit
          </a>
          <a href="<?= route('supervisor.tickets.delete', ['id' => $ticket->id]) ?>" class="text-red-600 hover:underline flex items-center" onclick="return confirm('Are you sure you want to delete this ticket?')">
